...
const createResult = async data => {
  let createdResult;
  try {
    createdResult = await fetch(`${process.env.DEV_API}/bulk/result`, {
      method: "post",
      headers: {
...
const updateResult = async data => {
  ...
  delete data.id;
  try {
    updatedResult = await fetch(`${process.env.DEV_API}/result/${id}`, {
      method: "put",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
...
const deleteResult = async id => {
  let deletedResult;
  try {
    deletedResult = await fetch(`${process.env.DEV_API}/result/${id}`, {
      method: "delete",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
...
const deleteAllResult = async () => {
  ...
  try {
    deletedResultFeedback = await fetch(`${process.env.DEV_API}/result`, {
      method: "delete",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
