...
const createPridiction = async data => {
  ...
  try {
    createdPrediction = await fetch(`${process.env.API_URL}/prediction`, {
      method: "post",
      headers: {
...
const updatePrediction = async data => {
  ...
  delete data.id;
  try {
    updatedPrediction = await fetch(`${process.env.API_URL}/prediction/${id}`, {
      method: "put",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
...
const deletePrediction = async id => {
  ...
  try {
    deletedPrediction = await fetch(`${process.env.API_URL}/prediction/${id}`, {
      method: "delete",
      headers: {
        "Content-Type": "application/json",
        Accept: "application/json",
...
const deleteAllPrediction = async () => {
  ...
  try {
    deletedPredictionFeedback = await fetch(
      `${process.env.API_URL}/prediction`,
      {
        method: "delete",
        headers: {
          "Content-Type": "application/json",
